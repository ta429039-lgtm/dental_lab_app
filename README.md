...
- `manifest.json` — referenced resource
- `service-worker.js` — referenced resource
...
`assets/` — 2 in this export — and the exported files refer to them there. A
